...
@ShaneHarvey
ShaneHarvey PYTHON-3447 Add back empty tls extra to avoid pip warnings (#1065)
Latest commit c9ac5a5 12 days ago
 History
 12 contributors
@behackett@ShaneHarvey@blink1073@prashantmital@ajdavis@dcrosta@terencehonles@thisch@rozza@juliusgeo@dongweiming@bcwarner
 Executable File  348 lines (288 sloc)  11.7 KB
...
Blog
About
mongo-python-driver/setup.py at master · mongodb/mongo-python-driver
